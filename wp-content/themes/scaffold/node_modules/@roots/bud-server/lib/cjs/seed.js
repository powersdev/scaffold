...
const seed = (app) => {
    app.hooks
        ...
        .hooks.on(`middleware.hot.options.path`, () => `${app.hooks.filter('build.output.publicPath')}__hmr`)
         ...
         * Proxy interception
         */
        .hooks.action(`event.proxy.interceptor`, async (app) => app.hooks.on(`middleware.proxy.replacements`, (replacements) => [
        ...(replacements ?? []),
