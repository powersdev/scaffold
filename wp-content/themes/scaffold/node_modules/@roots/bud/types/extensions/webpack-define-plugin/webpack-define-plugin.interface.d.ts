...
export interface BudWebpackDefinePlugin extends Extension.CompilerPlugin<Webpack.DefinePlugin, Options> {
...
//# sourceMappingURL=webpack-define-plugin.interface.d.ts.map