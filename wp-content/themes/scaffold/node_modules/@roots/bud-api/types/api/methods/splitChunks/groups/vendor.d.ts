 ...
 * @public
 */
export declare const chunks = "all";
/**
 * Cache group test
 *
 * @remarks
 ...
 * @public
 */
export declare const name: (_module: string, chunks: Array<{
    name: string;
}>, cacheGroupKey: string) => string;
/**
 * Reuse existing chunk
 *
 * @public
 */
export declare const reuseExistingChunk = true;
/**
 * Chunk priority
 *
 * @remarks
 ...
 * @public
 */
export declare const priority = -20;
