...
export { bind };
export declare const isEqual: (value: any, other: any) => boolean, isString: (value?: any) => value is string, get: {
...
}, isFunction: (value: any) => value is (...args: any[]) => any, isNull: (value: any) => value is null, isUndefined: (value: any) => value is undefined;
//# sourceMappingURL=extensions.dependencies.d.ts.map